 ...
 */
class FavoriteShopsRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return FavoriteShops[] Returns an array of FavoriteShops objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?FavoriteShops
    {
        return $this->createQueryBuilder('f')
            ->andWhere('f.exampleField = :val')
            ->setParameter('val', $value)
